...
class TypeChecked(BaseModel, ABC):
    """ A base class for type-checked models using Pydantic.
    
    Note:
        - Inherits from Pydantic's BaseModel to leverage data validation and serialization.
        - Subclasses can define fields with type annotations for automatic validation.
        - The `Config` class can be customized in subclasses to modify Pydantic behavior.
